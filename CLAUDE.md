...
| **7.8 The card** | **done 2026-07-31**, migration 011 applied. Runs per MATCH (A54), disciplines added (A55), Player of the Match priced in (A56), a declared reputation blend (A57), integer 70-100 percentile-anchored scale (A58). **A view replacement only.** `etl.feasibility` now reads `rated_per_ball`; check 22 pins the card against the engine. Kohli 2016 75.4 -> **98**, Bumrah's range 37.6-92.9 -> **78-98**, Narine 2024 69.7 -> **95**, finishers 20% -> **0%** of the top 20. |
