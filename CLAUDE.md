...
**15 checks: 13 pass, 2 fail.** Check 21 is the new one and it fails by design too — see A51. The other failure is check 19 and it is correct — 26
...
|---|---|---|---|
| `nationality.csv` | `nationality` | **13 of 327** (A51: the original 314 are filled; 13 archive-resolved rows are newly offered) | the four-overseas rule |
