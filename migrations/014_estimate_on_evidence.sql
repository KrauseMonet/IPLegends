-- SPEC 7.11. Estimate parameters where the evidence is adequate; rate everyone.
--
-- A VIEW REPLACEMENT AND NOTHING ELSE, as 010-013 were. It corrects two things 013 got
-- wrong, both found by checks that 013 broke rather than by reading it back.
